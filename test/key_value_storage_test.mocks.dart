...
class MockFlutterSecureStorage extends _i1.Mock implements _i2.FlutterSecureStorage {
  ...
  Map<String, List<_i3.ValueChanged<String?>>> get getListeners =>
      (super.noSuchMethod(Invocation.getter(#getListeners), returnValue: <String, List<_i3.ValueChanged<String?>>>{})
          as Map<String, List<_i3.ValueChanged<String?>>>);

  @override
  void registerListener({required String? key, required _i3.ValueChanged<String?>? listener}) => super.noSuchMethod(
    Invocation.method(#registerListener, [], {#key: key, #listener: listener}),
    returnValueForMissingStub: null,
  );

  @override
  void unregisterListener({required String? key, required _i3.ValueChanged<String?>? listener}) => super.noSuchMethod(
